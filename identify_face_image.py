...
directorioImagenesSinClasificar = "/run/user/1000/gvfs/smb-share:server=raspberrypi.local,share=raw/2020-04-26"
...
for carpetasacrear in listadecarpetas:
	try:
	  os.stat(directorioImagenesReconocidas+"/"+str(carpetasacrear))

	except:
	  os.mkdir(directorioImagenesReconocidas+"/"+str(carpetasacrear))
	try:
	  os.stat(directorioImagenesDesconocidas+"/"+str(carpetasacrear))

	except:
	  os.mkdir(directorioImagenesDesconocidas+"/"+str(carpetasacrear))	 

	directorioactual = str(listadirectorios) + "/" + str(carpetasacrear)
	ListaImagenes = os.listdir(directorioactual)
	print("***********************************                "+directorioactual)
	ListaImagenes.sort()

	for imagensinclasificar in ListaImagenes:
		print("Nombre de imagen: " + str(imagensinclasificar))
		with tf.Graph().as_default():
			...
			frame = cv2.imread(directorioactual + "/" + str(imagensinclasificar),0)
